...
public class NodeMetric implements Serializable {
    ...
    @JsonProperty("error_5xx_rate")
    public double error5xxRate;
    @JsonProperty("cache_hit_ratio")
    public double cacheHitRatio;
    @JsonProperty("bytes_sent")
    public long bytesSent;
    @JsonProperty("origin_ms_total")
    public double originMsTotal;
    @JsonProperty("ttfb_p50_ms")
    public double ttfbP50Ms;
    @JsonProperty("ttfb_p95_ms")
    public double ttfbP95Ms;
    @JsonProperty("ttfb_p99_ms")
